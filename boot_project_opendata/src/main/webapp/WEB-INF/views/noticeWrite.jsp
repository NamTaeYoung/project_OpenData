  ...
  <section class="write-section">
    <div class="write-container">
      <div class="write-header">
        <h1 class="write-title">공지사항 글쓰기</h1>
      </div>

      <form class="write-form" id="writeForm" method="post" action="/notice/write" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <%-- 백엔드 연동 시: 로그인한 관리자 정보 자동 입력
          <input type="text" id="writer" name="writer" class="form-input" value="${sessionScope.loginDisplayName}" readonly>
          --%>
        </div>
        ...
        <div class="form-actions">
          <button type="button" class="btn btn-cancel" onclick="location.href='/notice'">취소</button>
