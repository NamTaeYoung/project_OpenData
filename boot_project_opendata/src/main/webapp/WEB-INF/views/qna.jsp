  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    @media (max-width: 720px){
      ...
      .promo-nav{ gap: 32px; }
      .promo-nav a{ font-weight: 700; font-size: 16px; }
      .promo-nav a + a::before{ left: -16px; height: 20px; }
    }
    ...
    .qna-table th:nth-child(1) { width: 10%; }
    .qna-table th:nth-child(2) { width: 45%; }
    .qna-table th:nth-child(3) { width: 15%; }
    .qna-table th:nth-child(4) { width: 15%; }
    .qna-table th:nth-child(5) { width: 15%; }
    .qna-table tbody tr {
    ...
    @media (max-width: 768px){
      ...
      .qna-table th:nth-child(1) { width: 15%; }
      .qna-table th:nth-child(2) { width: 70%; }
      .qna-table th:nth-child(5) { width: 15%; }
      .search-input {
        width: 100%;
      }
