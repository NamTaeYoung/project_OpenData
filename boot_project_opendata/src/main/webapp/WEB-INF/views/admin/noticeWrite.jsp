...
<body>
  ...
  <section class="write-section">
    <div class="write-container">
      ...
      <form class="write-form" id="writeForm" method="post" action="/noticeManagement/noticeWrite" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" id="title" name="title" class="form-input" placeholder="제목을 입력하세요" required value="[공지]">
        </div>

        <div class="form-group">
          <label class="form-label required" for="writer">작성자</label>
          <input type="text" id="writer" name="writer" class="form-input" placeholder="작성자를 입력하세요" required value="[관리자]">
        ...
        <div class="form-actions">
          <button type="button" class="btn btn-cancel" onclick="location.href='/noticeMangement'">취소</button>
